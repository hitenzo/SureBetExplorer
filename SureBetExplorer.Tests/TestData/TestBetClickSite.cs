...
{
    public class TestBetClickSite : IBettingWebsite
    {
        private List<Tuple<string, double, double, double>> _events = new List<Tuple<string, double, double, double>>
        {
            new Tuple<string, double, double, double> ("Anderlecht - Apoel Nikozja", double.Parse("5,3"), double.Parse("4,0"), double.Parse("4,90")),
